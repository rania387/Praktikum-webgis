...
function categories_aksesibilitas_univunion_1(feature, value, size, resolution, labelText,
        ...
        stroke: new ol.style.Stroke({color: 'rgba(123,205,42,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.988}),
...
case '2,4km (30 menit)':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(60,129,202,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.988}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
